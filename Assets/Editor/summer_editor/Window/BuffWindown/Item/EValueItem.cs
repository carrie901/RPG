...
namespace SummerEditor
{
    ...
    /// 数值变更
    /// </summary>
    public class EValueItem : EBaseffectInfoItem
    {
        ...
        public EValueItem(float width, float height) : base(width, height)
        {
            _init();
            _init_position();
        }
        ...
        public void _init()
        {
            ...
            _baifenbi_toggle = new EToggleBar("百分比(百分制)", 100);
