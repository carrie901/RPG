...
{
    /// <summary>
    /// 2018.11.28 时间太久远了。所以先屏蔽掉，等后续要用了再开放出来
    /// 
    /// 
    ...
    public class AllocMem : MonoBehaviour
    {
        ...
        /*
            ...
            public void OnGUI()
            {
                ...
                text.Append("最近收集的一帧:            ");
                text.Append(last_gc_frame.ToString("0.000"));#1#
                ...
                /*GUI.Label (new Rect (5,5,1000,200),
                    ...
                    "Last collect delta            "+lastDeltaTime.ToString ("0.000") + " ("+(1F/lastDeltaTime).ToString ("0.0")+")");#1#
            }
