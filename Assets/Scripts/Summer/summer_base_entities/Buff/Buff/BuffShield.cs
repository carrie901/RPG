namespace Summer
{
    ...
    public class BuffShield : Buff
    {
       /* BuffParamData _param = new BuffParamData();
        ...
        public override void OnAttach(BaseEntity target, BaseEntity caster)
        {
            base.OnAttach(target, caster);
            _target.RegisterHandler(E_AbilityTrigger.on_def_damage_before, _on_def_damage_before);
        }

        public override void OnDetach()
        {
            _target.UnRegisterHandler(E_AbilityTrigger.on_def_damage_before, _on_def_damage_before);
            base.OnDetach();
        }

        public void _on_def_damage_before(EventSetData param)
        {
