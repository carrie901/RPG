...
namespace Summer
{
    ...
    public class SpringBone : MonoBehaviour
    {
        ...
        private float springLength;         // 弹簧长度
        ...
        public SpringManager _managerRef;
        ...
        private void Awake()
        {
            ...
            //_managerRef = GetParentSpringManager(transform);
        }
        ...
        public void UpdateSpring()
        {
            ...
            trs.rotation = Quaternion.Lerp(org.rotation, secondaryRotation, _managerRef.dynamicRatio);
        }
